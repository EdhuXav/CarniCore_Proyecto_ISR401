...
\date{Versión del documento 3.0 -- Fecha de entrega: \PENDIENTE{Completar, semana 13, 2026--2027 PPA}}
...
\textcolor{red}{PENDIENTE: No existe un archivo multimedia para esta sección.}

\noindent\textit{Nota: Se requiere el diagrama de contexto (system boundary) del sistema CarniCore con los actores: Propietaria, Administrador General, Encargado de Bodega, Carnicero, Cliente/Sucursal, Proveedor/Granja, Agrocalidad. Debe depositarse en \texttt{03\_Modelado/Diagramas\_UML/} con exportación PNG $\geq 300$~dpi.}
...
\noindent\textcolor{red}{PENDIENTE: No existe un archivo del Diagrama de Razón Estratégica (SR) en el repositorio. Debe crearse y depositarse en \texttt{03\_Modelado/Diagramas\_UML/} en notación i* con los elementos internos (tareas, metas blandas, recursos) de cada actor.}
...
\textcolor{red}{PENDIENTE: No existe un archivo multimedia para esta sección. Se requieren prototipos de interfaz de alta fidelidad (mockups) de todas las pantallas \textit{Debe tener} como archivos SVG/PNG en \texttt{03\_Modelado/Mockups/}, cada uno con identificador MU-\textit{XX}. Enlace vigente a Figma como respaldo, no como evidencia única.}
...
\textcolor{red}{PENDIENTE: No existe un archivo multimedia para esta sección. Se requiere el diagrama de casos de uso general del sistema CarniCore (heredado y ampliado de la Figura 4.1 de la Entrega 1B), con los cinco actores principales y doce casos de uso CU-01 a CU-12, incluyendo relaciones \textit{include}. Debe depositarse en \texttt{03\_Modelado/Diagramas\_UML/} con exportaciones PNG ($\geq$300 dpi) y SVG.}
...
\textcolor{red}{PENDIENTE: No existe un archivo multimedia para esta sección. Se requiere el diagrama de clases refinado con atributos y operaciones completas, archivo fuente editable y exportaciones PNG/SVG en \texttt{03\_Modelado/Diagramas\_UML/}.}

\subsection{Diagramas de secuencia (CU \textit{Debe tener})}
\textcolor{red}{PENDIENTE: No existe un archivo multimedia para esta sección. Se requieren los diagramas de secuencia para CU-01, CU-02, CU-03, CU-04, CU-06, CU-07, CU-08, CU-09, CU-10, CU-11 y CU-12, mostrando la interacción entre el actor, la interfaz, el controlador y las clases del dominio afectadas por cada caso de uso.}

\subsection{Diagramas de actividad (flujos principales)}
\textcolor{red}{PENDIENTE: No existe un archivo multimedia para esta sección. Se requieren los diagramas de actividad para el flujo de recepción-pesaje-despiece-almacenamiento (CU-01 a CU-06) y para el flujo de venta con validación de inventario (CU-09), incluyendo nodos de decisión para las excepciones documentadas en la Sección~4.2.}
...
\textcolor{red}{PENDIENTE: No existe un archivo multimedia para esta sección. Se requiere el diagrama de estados formal (UML statechart) de \texttt{ProductoAlmacenado}, con transiciones etiquetadas por el evento/RF que las dispara, en \texttt{03\_Modelado/Diagramas\_UML/}.}

\subsection{Diagrama de componentes}
\textcolor{red}{PENDIENTE: No existe un archivo multimedia para esta sección. Se requiere el diagrama de componentes mostrando al menos: componente de Interfaz Web/Móvil, componente de API/Backend (módulos de Ingreso, Pesaje, Trazabilidad, Inventario, Reportes, Usuarios), componente de Sincronización Offline (RF-21) y componente de Base de Datos, con sus interfaces provistas/requeridas.}

\subsection{Diagrama de despliegue}
\textcolor{red}{PENDIENTE: No existe un archivo multimedia para esta sección. Se requiere el diagrama de despliegue mostrando: dispositivos cliente (PC/tablet en punto de pesaje, tablet móvil de bodega), servidor de aplicación/API, servidor de base de datos, y el nodo de almacenamiento local para el modo de contingencia offline (RF-21), con los protocolos de comunicación (HTTPS) entre nodos.}
...
6 & -- & Registro de cortes & Carniceros & EV-05 & RF-06 & CU-04 & HU-06 & CA-06 & Backend-Despiece & \textcolor{red}{PENDIENTE} \\
...
9 & Art.38 & Sustentar bajas & Admin. gral. & EV-07 & RF-09 & CU-10 & HU-09 & CA-09 & Backend-Bajas & \textcolor{red}{PENDIENTE} \\
10 & -- & Registrar ventas & Bodega/Cliente & EV-08 & RF-10 & CU-09 & HU-10 & CA-10 & Backend-Ventas & \textcolor{red}{PENDIENTE} \\
11 & -- & Historial completo & Agrocalidad/Prop. & EV-03 & RF-11 & CU-08 & HU-11 & CA-11 & Backend-Trazabilidad & MU-06 \\
12 & -- & Diferencias de inventario & Admin. gral. & EV-09 & RF-12 & CU-11 & -- & -- & Backend-Inventario & \textcolor{red}{PENDIENTE} \\
...
16 & -- & Stock por fecha & Propietaria & EV-09 & RF-16 & CU-06 & HU-16 & CA-16 & Backend-Inventario & \textcolor{red}{PENDIENTE} \\
17 & -- & Georreferencia & Admin. gral. & \textcolor{red}{PENDIENTE} & RF-17 & CU-01 & -- & -- & Backend-Proveedores & \textcolor{red}{PENDIENTE} \\
18 & -- & Historial de precios & Propietaria & \textcolor{red}{PENDIENTE} & RF-18 & -- & -- & -- & Backend-Precios & \textcolor{red}{PENDIENTE} \\
19 & -- & Configurar precios & Propietaria & \textcolor{red}{PENDIENTE} & RF-19 & CU-03 & HU-19 & CA-19 & Backend-Precios & \textcolor{red}{PENDIENTE} \\
20 & -- & Registrar apagones & Propietaria & \textcolor{red}{PENDIENTE} & RF-20 & CU-10 & HU-20 & CA-20 & Backend-Incidentes & \textcolor{red}{PENDIENTE} \\
21 & -- & Continuidad operativa & Bodega & \textcolor{red}{PENDIENTE} & RF-21 & CU-01/CU-03 & HU-21 & CA-21 & Cliente-Offline & \textcolor{red}{PENDIENTE} \\
22 & -- & Devoluciones & Bodega & \textcolor{red}{PENDIENTE} & RF-22 & CU-09 & -- & -- & Backend-Ventas & \textcolor{red}{PENDIENTE} \\
23 & -- & Auditoría Agrocalidad & Admin. gral. & \textcolor{red}{PENDIENTE} & RF-23 & CU-08 & HU-23 & CA-23 & Backend-Trazabilidad & \textcolor{red}{PENDIENTE} \\
24 & -- & Búsqueda de producto & Bodega & \textcolor{red}{PENDIENTE} & RF-24 & CU-06 & -- & -- & Backend-Inventario & \textcolor{red}{PENDIENTE} \\
25 & -- & QR de trazabilidad & Cliente & \textcolor{red}{PENDIENTE} & RF-25 & CU-08 & -- & -- & Backend-Trazabilidad & \textcolor{red}{PENDIENTE} \\
...
33 & -- & Cobertura RF Must en MVP & Docente/Equipo & \textcolor{red}{PENDIENTE} & RNF-08 & -- & -- & -- & MVP & -- \\
34 & -- & Integración con báscula & Bodega & -- & RNF-09 & CU-03 & -- & -- & Backend-Pesaje & -- \\
35 & -- & Nuevos tipos de producto & Propietaria & \textcolor{red}{PENDIENTE} & RNF-10 & -- & -- & -- & Backend-Precios & -- \\
...
39 & -- & Recuperabilidad offline & Bodega & \textcolor{red}{PENDIENTE} & RNF-14 & CU-01/CU-03 & HU-21 & CA-21 & Cliente-Offline & -- \\
40 & -- & Calidad del código MVP & Docente/Equipo & \textcolor{red}{PENDIENTE} & RNF-15 & -- & -- & -- & MVP & -- \\
\hline
\end{longtable}
\normalsize
...
%======================================================
Para facilitar la verificación docente, se consolida aquí todo lo marcado como \PENDIENTE{...} a lo largo del documento. Los ítems marcados con \textbf{[RESUELTO PARCIALMENTE]} cuentan con al menos un archivo en el repositorio; los restantes requieren creación completa.
\begin{enumerate}[nosep]
\item Diagrama de contexto del sistema -- Sección~2.1. \textcolor{red}{PENDIENTE: No existe archivo en el repositorio.}
\item Mockups de alta fidelidad MU-01 a MU-\textit{XX} -- Sección~3.1.1. \textcolor{red}{PENDIENTE: No existen archivos en el repositorio.}
\item Diagrama i* SD -- Sección~2.4. \textbf{[RESUELTO PARCIALMENTE]} Archivo existente: \texttt{istar\_SD.svg}
\item Diagrama i* SR -- Sección~2.4. \textcolor{red}{PENDIENTE: No existe archivo en el repositorio.}
\item Evidencia real (EV-17 a EV-25) de la segunda ronda para RF-17 a RF-25 -- Sección~3.2. \textcolor{red}{PENDIENTE.}
\item Verificación INVEST completa y validación con stakeholders de todas las historias de usuario -- Sección~3.6. \textcolor{red}{PENDIENTE.}
\item Diagrama de casos de uso general -- Sección~4.1. \textcolor{red}{PENDIENTE: No existe archivo en el repositorio.}
\item Diagrama de clases refinado con atributos/operaciones -- Sección~4.3. \textcolor{red}{PENDIENTE: No existe archivo en el repositorio.}
\item Diagramas de secuencia de los CU \textit{Debe tener} -- Sección~4.4. \textcolor{red}{PENDIENTE: No existen archivos en el repositorio.}
\item Diagramas de actividad de los flujos principales -- Sección~4.5. \textcolor{red}{PENDIENTE: No existen archivos en el repositorio.}
\item Diagrama de estados de \texttt{ProductoAlmacenado} -- Sección~4.6. \textcolor{red}{PENDIENTE: No existe archivo en el repositorio.}
\item Diagrama de componentes -- Sección~4.7. \textcolor{red}{PENDIENTE: No existe archivo en el repositorio.}
\item Diagrama de despliegue -- Sección~4.8. \textcolor{red}{PENDIENTE: No existe archivo en el repositorio.}
\item Cálculo formal de WSJF validado con el equipo y la propietaria -- Sección~5.1. \textcolor{red}{PENDIENTE.}
\item Mockups pendientes referenciados en la matriz de trazabilidad -- Sección~5.2, filas 6, 9, 10, 12, 16--25. \textcolor{red}{PENDIENTE.}
\item Repositorio Git del MVP con demo funcional -- Sección~6. \textcolor{red}{PENDIENTE.}
\item Protocolo experimental completo y ejecución real del Enfoque 2 -- Sección~7. \textcolor{red}{PENDIENTE.}
\item Título, resumen, búsqueda de revista objetivo y borrador de manuscrito v1.0 -- Sección~8. \textcolor{red}{PENDIENTE.}
\item Paquete de datos FAIR para Zenodo -- Sección~8. \textcolor{red}{PENDIENTE.}
\item Evidencias completas de la segunda ronda de elicitación -- Apéndice~B. \textcolor{red}{PENDIENTE.}
\item Estructura completa del repositorio GitHub y archivos raíz obligatorios -- Apéndice~D. \textcolor{red}{PENDIENTE.}
\item Datos de integrantes del equipo (nombres completos, cédulas y roles) -- Portada. \textcolor{red}{PENDIENTE.}
\item Fecha de versión 3.0 y firma electrónica del analista líder -- Portada. \textcolor{red}{PENDIENTE.}
\end{enumerate}
