...
\begin{titlepage}
    ...
    \textbf{\large INGENIERÍA DE REQUERIMIENTOS [20303] -- ISR-401}\\[0.5cm]
    ...
    {\normalsize \textbf{Entrega 4 (2B / Defensa Final): Versión Definitiva v2.0}}\\
    {\normalsize Estándar: ISO/IEC/IEEE 29148:2018 -- ISO/IEC 25010:2023}\\[0.2cm]

    \rule{\textwidth}{1pt}\\[0.5cm]

    \textbf{PROYECTO:} CarniCore\\[0.3cm]
    ...
    \textbf{FECHA:} Semana 17 -- agosto 28 del 2026\\[0.3cm]
    \textbf{REPOSITORIO:}\\[0.2cm]
    \url{https://github.com/EdhuXav/CarniCore_Proyecto_ISR401}\\[0.4cm]
    \textbf{REVISIÓN:} Último commit hasta el miércoles 2 se septiembre 23:55 PM\\[0.3cm]
    \textbf{DEPÓSITO FAIR (ZENODO):}\\[0.2cm]
    DOI en trámite -- pendiente de asignación tras el depósito final del paquete de datos (ver PR de cierre del repositorio)\\[0.2cm]
    \textbf{REGISTRO OSF:}\\[0.2cm]
    \url{https://osf.io/wud69}\\[0.4cm]
    \vfill
\end{titlepage}
...
El protocolo completo se encuentra en \texttt{06\_Experimento/protocolo.pdf} (v1.0, 02/08/2026) y fue registrado en OSF antes de toda recolección de datos (\url{https://osf.io/wud69}). Las desviaciones del protocolo respecto al pre-registro se documentan en \texttt{06\_Experimento/osf\_deviations.pdf}.
