...
\fancyhead[R]{\footnotesize Autoevaluación FAIR · versión 2.1}
...
{\large Sistema CarniCore · Entrega 4 (2B) · versión corregida 2.1}\\[8pt]
...
resultado es \textbf{13 de 16 (81,25\,\%)}, por encima del mínimo del 60\,\% que
...
\midrule
Entradas en \texttt{checksums.sha256} & 468 \\
Entradas que verifican & 468 \\
Archivos multimedia y contenedores cubiertos & 22 \\
Hashes de contenedores frente a \texttt{fichas\_tecnicas.csv} & 16 de 16 coinciden \\
\bottomrule
\end{tabular}
\end{center}
